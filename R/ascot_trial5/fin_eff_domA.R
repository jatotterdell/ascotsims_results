...
cfg <- list(
  b = list(
    c(qlogis(0.2), 0, 0, log(1.10), rep(0, 3)),
    c(qlogis(0.2), 0, 0, log(1/1.10), rep(0, 3)),
    c(qlogis(0.2), 0, 0, log(1/1.25), rep(0, 3)),
    c(qlogis(0.2), 0, 0, log(1/1.50), rep(0, 3)),
    c(qlogis(0.2), 0, 0, log(1/2.00), rep(0, 3))),
...
print_out("Running fin_eff_domA.R\n")
...
saveRDS(
  ...
  "~/out_files/ascot/ascot_sims5/fin_eff_domA.rds")
