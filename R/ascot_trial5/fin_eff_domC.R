...
cfg <- list(
  b = list(
    c(qlogis(0.2), 0, 0, 0, 0, 0, log(1.10)),
    c(qlogis(0.2), 0, 0, 0, 0, 0, log(1/1.10)),
    c(qlogis(0.2), 0, 0, 0, 0, 0, log(1/1.25)),
    c(qlogis(0.2), 0, 0, 0, 0, 0, log(1/1.50)),
    c(qlogis(0.2), 0, 0, 0, 0, 0, log(1/2.00))),
...
print_out("Running fin_eff_domC.R\n")
...
saveRDS(
  ...
  "~/out_files/ascot/ascot_sims5/fin_eff_domC.rds")
