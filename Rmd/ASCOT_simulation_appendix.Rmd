---
title: "ASCOT ADAPT Trial Simulation Appendix"
...
header-includes:
  ...
  - \pagestyle{fancy}
  - \fancyhf{}
  - \fancyhead[LO]{ASCOT ADAPT Simulation Appendix}
...
The primary endpoint in the trial is survival free of advanced respiratory support at 28 days after randomisation. 
This endpoint is binary and in these simulations a participants response is coded as 0 if they survived ventilation-free to 28 days and is 1 if they did not. 
Therefore, a beneficial treatment is one which reduces the probability of the outcome.
